...
const Login = () => {
    ...
    const submitUser = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL}user/login`, {
        ...
        <Container>
            ...
            <form onSubmit={submitUser}>
                <div className='login-con p-0'>
                    ...
                    <div style={{ border: "1px solid #5e5e5e4b" }} className='py-4 row  row-gap-4'>
                    ...
                    <div className='d-flex justify-content-end row py-3' style={{ border: "1px solid #5e5e5e4b" }}>
                        ...
                        <div className='d-flex column-gap-3 align-items-center'>
                            ...
                            <div className='text-danger ' style={{ textDecoration: "underline" }}>Forget Password ?</div>

                            <button type="submit" className='text-center cursor-pointer py-2 px-4 rounded-5 text-white' style={{ background: "#fa693e" }}>
                    ...
                    <div className='d-flex column-gap-3 mt-10 px-2 py-4 row  justify-content-center' style={{ border: "1px solid #5e5e5e4b" }}>

                        <div className='font-bold'>If you dont have account</div>


                        <Link to={"/Register"}>
                            <div className='text-center py-2 px-4 rounded-5 mt-4 text-white' style={{ background: "#fa693e" }}>
                                Register
                            </div>
                        </Link>
